<div class="row col-lg-12">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-gradient-dark">
                <h4 class="text-white">Laporan Data Status Pinjam Buku</h4>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-gradient-dark">
                <h4 class="text-white">Laporan Data Denda Buku</h4>
            </div>
            <div class="card-body">
                <div class="card-header py-3">
                    <div class="container-fluid">
                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0 admin" id="laporandatadenda">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Santri</th>
    ...
    <div class="col-lg-12 mt-3">
        <div class="card">
            <div class="card-header bg-gradient-dark">
                <h4 class="text-white">Laporan Data Pengambilan Buku</h4>
            </div>
            <div class="card-body">
                <div class="card-header py-3">
                    <div class="container-fluid">
                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0 admin" id="laporandatakembalian">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Santri</th>
